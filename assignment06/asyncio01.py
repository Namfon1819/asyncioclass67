...
##ผลลัพธ์
#Connecting to the database (self.db_name)...
#Connected to the database (self.db_name).
#Fetched data: {'data': 'sample data'}
#Closing the database connection to (self.db_name)...
#Closed the database connection to (self.db_name).